...
:::warning We are currently undergoing a rename from [QHub](https://docs.qhub.dev/) to Nebari.   
:construction: Please excuse our dust as we build out our new docs :) :construction:
:::
...
Nebari provides enables teams to build their own scalable compute infrastructure with:
...
- Option to choose from multiple compute instances, such as: **normal**, **high memory**, **GPU**, etc.
...
<!-- 
![handshake icon](/img/icon_handshake.jpg) Quickly Deploys a Jupyterhub environment where data scientists can collaborate  
![gear icon](/img/icon_gear.jpg) Provides a foundation for deploying additional technologies  
![chart icon](/img/icon_chart.jpg) Enables scalability beyond the limits of local machines  
![cloud icon](/img/icon_cloud.jpg) Cloud deployment on multiple cloud platforms with minimal experience   
-->
