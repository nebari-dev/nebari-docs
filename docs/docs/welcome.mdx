...
You can be an administrator configuring resourcesfor your team, or a data scientist looking to create dashboards.
...
<Tabs>
  <TabItem value="data-scientist" label="Data scientist" default>

  If you are a data professional using Nebari for your day-to-day work like data analysis, visualization, and more, the following path and pages will be useful for you.
  ...
  🔸 If you need to run notebooks or scripts regularly (cronjobs), [you can read how to use `kbatch`](./how-tos/kbatch-howto).
  ...
  If you are setting up Nebari and managing the platform for your organization, the following steps and pages will be helpful.
...
<!-- TODO in Admin path: Add advanced setting page, upgrading, migration guide. -->
<!-- TODO in Just curious path: Add Nebari 101 when ready. -->
