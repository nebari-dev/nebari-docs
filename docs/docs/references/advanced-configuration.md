...
> NOTE: Many of the cloud providers regularly update their internal Kubernetes versions so if you wish to specify a particular version, please check the following resources. This
> is _completely optional_ as QHub will, by default, select the most recent version available for your preferred cloud provider.
