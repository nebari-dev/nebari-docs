...
:::note
You will need to make sure you have an environment set up that can run your notebook. See this [tutorial](/docs/tutorials/creating-new-environments.md) to learn how to create environments in Nebari.
