...
You should choose another installation option, likely a [cloud install](docs/get-started/cloud-providers) if you are starting from scratch (you have no compute clusters already in place) and you desire to stand up a production instance of Nebari.
...
[nebari-deploy]: /docs/get-started/deploy.mdx
[supported-cloud-providers]: /docs/get-started/cloud-providers.mdx
