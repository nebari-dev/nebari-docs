...
New to Nebari?
The issues marked with the ["good first issue"][good-first-issues] label are an excellent place to start.
...
[good-first-issues]: https://github.com/nebari-dev/nebari/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22
