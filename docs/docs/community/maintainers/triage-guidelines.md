...
:::tip
Assign one and only one `type:` label to the issue and as many `area:` labels as are relevant. Take special care to evaluate issues as "good first issue" to allow new comers to contribute to Nebari.
