...
Bumping `kubernetes_version` has additional requirements. See [Upgrade Kubernetes version](/docs/how-tos/upgrade-kubernetes) — EKS and k3s both require one-minor-version increments.
:::
