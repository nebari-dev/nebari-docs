...
> **NOTE**: In some cases you may need to inspect services launched by your cluster at your `localhost` to view your cluster. For instance, if your cluster has problems with the network traffic tunnel configuration, the cluster may limit or block the user’s access to destination resources over the connection.
