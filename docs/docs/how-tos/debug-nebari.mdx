...
Generaly, it does not mean that there will be a file named kubeconfig present in you machine.
:::
...
#### Viewing all pods in a namespace
...
#### Executing a command inside a specific pod
...
by setting the `--kubeconfig` flag. Generaly, your cloud provider CLI will automatically
