...
To upgrade the EKS Kubernetes version, see [Upgrade Kubernetes version](/docs/how-tos/upgrade-kubernetes). EKS requires one-minor-version increments — you cannot skip versions.
:::
