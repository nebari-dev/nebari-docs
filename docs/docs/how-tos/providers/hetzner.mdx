...
To upgrade the k3s Kubernetes version, see [Upgrade Kubernetes version](/docs/how-tos/upgrade-kubernetes). Hetzner k3s requires one-minor-version increments — you cannot skip versions.
:::
