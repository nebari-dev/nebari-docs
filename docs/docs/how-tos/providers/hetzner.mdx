...
To upgrade the k3s Kubernetes version, see [Upgrade Kubernetes version](/docs/how-tos/upgrade-kubernetes). Bump `kubernetes_version` by one minor version at a time.
:::
