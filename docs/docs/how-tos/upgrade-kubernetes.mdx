...
1. Edit `kubernetes_version` in your config — bump by one minor version. See your [provider's page](/docs/how-tos/providers) for the exact field path and accepted version formats.
