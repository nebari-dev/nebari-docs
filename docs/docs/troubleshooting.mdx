...
Follow the instructions in the [Handle Access to restricted namespaces](docs/troubleshooting#handle-access-to-restricted-namespaces) to grant the necessary permissions.
:::
...
![K9s CLI main screen - displaying information for a local minikube cluster](../static/img/troubleshooting/k9s_UI.png)
