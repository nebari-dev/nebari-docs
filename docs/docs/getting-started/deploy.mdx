...
You should choose another installation option, likely a [cloud install](docs/getting-started/cloud-providers) if you are starting from scratch (you have no compute clusters already in place) and you desire to stand up a production instance of Nebari.

For instructions on installing and deploying Nebari Local, please visit [How to install and setup Nebari on an existing Kubernetes infrastructure](docs/how-tos/nebari-local).
...
[nebari-aws]: /docs/how-tos/nebari-aws.md
[nebari-azure]: /docs/how-tos/nebari-azure.md
[nebari-do]: /docs/how-tos/nebari-do.md
[nebari-gcp]: /docs/how-tos/nebari-gcp.md
[nebari-hpc]: /docs/how-tos/nebari-hpc.md
[nebari-local]: /docs/how-tos/nebari-local.md
[nebari-deploy]: /docs/getting-started/deploy.mdx
[supported-cloud-providers]: /docs/getting-started/cloud-providers.mdx
