...
Typically, you can upgrade the qhub-config.yaml file itself by manually adding the intended version to the file. And validating that the version matches the version of Nebari you are deploying with `qhub --version`.
