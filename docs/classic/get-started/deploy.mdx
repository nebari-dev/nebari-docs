...
For instructions on installing and deploying Nebari Local, please visit [Deploying Nebari on a local machine](/classic/how-tos/nebari-local.md).
...
For instructions on installing and deploying Nebari on an existing Kubernetes cluster, please visit [How to install and setup Nebari on an existing Kubernetes infrastructure](/classic/how-tos/nebari-kubernets.mdx).
