...
<img src="/img/classic/how-tos/aws_tag_editor_1.png" alt="Search for Tag Editor in the AWS console" width="700"/>

2. From the `Resource Groups & Tag Editor` page, navigate to `Tag Editor` from the left most panel

<img src="/img/classic/how-tos/aws_tag_editor_2.png" alt="Navigate to the Tag Editor in the AWS console" width="200"/>
...
<img src="/img/classic/how-tos/aws_tag_editor_3.png" alt="Use the Tag Editor to filter for lingering Nebari resources" width="700"/>
