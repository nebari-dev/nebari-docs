...
:::tip
For guidance on managing or creating environments directly with conda-store, see our guide on [Creating new environments on Nebari](/tutorials/creating-new-environments/).
If you're looking for information on updating your namespaces after a recent upgrade, refer to our troubleshooting guide on [Migrating namespaces](/troubleshooting/#conda-store-compatibility-migration-steps-when-upgrading-to-045).
:::
...
For more information please refer to [Handle Access to restricted namespaces](/troubleshooting/#handle-access-to-restricted-namespaces)
:::
