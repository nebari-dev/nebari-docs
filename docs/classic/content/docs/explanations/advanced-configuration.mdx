...
theme:
  jupyterhub:
    ...
    welcome: Welcome! Learn about Nebari's features and configurations in <a href="https://classic.nebari.dev/">the
...
`project_name`: Determines the base name for all major infrastructure related resources on Nebari. Should be compatible with the Cloud provider's naming conventions. See [Project Naming Conventions](/explanations/config-best-practices/#naming-conventions) for more details.
...
{/* For more information regarding the format of this field, see [Domain Format](/explanations/config-best-practices/#domain-format). */}
...
:::note
In order for your CI/CD pipeline to be able to deploy changes into your Nebari cloud hosting provider, you must set the appropriate authentication environment variables for your GitLab or GitHub CI/CD execution environment. See the Authentication section for deploing to [AWS](/how-tos/nebari-aws/#authentication), [Azure](/how-tos/nebari-azure#authentication), or [GCP](/how-tos/nebari-gcp/#authentication) for Nebari's required variables. Guidance on how to set these for your repository/project can be found in the documentation for [GitHub Actions](https://docs.github.com/en/actions/learn-github-actions/variables) and [GitLab CI/CD](https://docs.gitlab.com/ee/ci/variables/).
:::
...
```
  ...
  <TabItem label="New Let's Encrypt">
...
:::
  ...
  <TabItem label="Custom self-signed">
...
- [Security configuration](/explanations/security-configuration/)
- [Cloud provider configuration](/explanations/provider-configuration/)
- [JupyterLab and Dask profile configuration](/explanations/profile-configuration/)
- [Customize JuputerHub theme](/explanations/custom-overrides-configuration/)
- [Environment configuration](/explanations/environments-configuration/)
- [Custom settings and overrides](/explanations/custom-overrides-configuration/)
