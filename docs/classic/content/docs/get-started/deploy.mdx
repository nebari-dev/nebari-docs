...
For instructions on installing and deploying Nebari Local, please visit [Deploying Nebari on a local machine](/how-tos/nebari-local/).
...
For instructions on installing and deploying Nebari on an existing Kubernetes cluster, please visit [How to install and setup Nebari on an existing Kubernetes infrastructure](/how-tos/nebari-kubernetes/).
