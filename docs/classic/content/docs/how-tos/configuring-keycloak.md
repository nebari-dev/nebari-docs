...
description: How to configure Keycloak, add new users, add new groups and update roles.
---
...
- Associate the user with one or more of the **Groups**. Out of the box, Nebari is deployed with the following groups: `admin`, `developer` and `analyst` (see [Creating and Managing Groups, Roles, and Directories](/how-tos/fine-grained-permissions/) for more details).
...
[keycloak-login]: /tutorials/login-keycloak/
