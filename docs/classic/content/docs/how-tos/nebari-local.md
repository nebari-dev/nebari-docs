...
To install kubectl and configure access to the Nebari cluster, refer to [Install and Set Up kubectl](/how-tos/debug-nebari/#getting-started-with-kubectl).
:::
...
- An installed version of Nebari, for any directions please visit [Install Nebari](/get-started/installing-nebari/) section,
...
See the [domain-registry documentation](/how-tos/domain-registry#what-is-a-dns) for details.
