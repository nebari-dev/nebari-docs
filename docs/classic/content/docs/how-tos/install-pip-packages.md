...
:::note
For more information on developing local packages, check out [the docs on developing packages on Nebari](/how-tos/develop-local-packages/).
:::
...
To learn more about using a "dev" install of local pip package for active development, check out the documentation on [installing a development package](/how-tos/develop-local-packages/).
