...
:::note
For more information, check out [the docs on installing pip packages](/how-tos/install-pip-packages/).
:::
...
To learn more about installing pip packages in general, check out the documentation on [installing pip packages from various sources](/how-tos/install-pip-packages/).
