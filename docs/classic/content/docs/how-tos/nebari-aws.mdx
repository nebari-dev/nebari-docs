...
Great, you’ve gone through the [Nebari installation](/get-started/installing-nebari/) and [authentication setup](#authentication) steps, and have ensured that all the necessary
