...
It is strongly recommended you [backup your data](/how-tos/manual-backup/) before upgrading!
...
:::note
New versions of Nebari often include support for newer versions of Kubernetes, as such you might need to upgrade your cluster's Kubernetes version. Please refer to [Upgrade Kubernetes version docs](/how-tos/kubernetes-version-upgrade/) for more details.
:::
...
Always [backup your data](/how-tos/manual-backup/) before upgrading!
...
Next, you will need to perform the following steps to restore from a previously generated backup, as described in the [Manual Backups documentation](/how-tos/manual-backup/):
...
1. Change the Keycloak `root` user password, documented [here](/how-tos/configuring-keycloak/#change-keycloak-root-password)
2. Import existing users, documented [here](/how-tos/manual-backup/#import-keycloak).
...
[login-keycloak]: /tutorials/login-keycloak/
