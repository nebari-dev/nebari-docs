...
<Tabs>
<TabItem label="JHub App Launcher">
...
<TabItem label="CDS Dashboards (Nebari v2023.7.1 or earlier)">
...
[create-env]: /tutorials/creating-new-environments/
[jub-app-launcher]: /how-tos/jhub-app-launcher/
