...
- Get Started -> /docs/category/getting-started
- Docs -> /docs
...
- Learn how.... -> /docs/category/getting-started

Footer:

- Quickstart -> /docs/category/getting-started (for now - we are working on a 101 page)
- Documentation -> /docs
