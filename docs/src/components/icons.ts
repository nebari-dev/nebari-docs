/**
 * Outline icons for the landing page (Lucide, ISC), keyed by their Lucide
 * names. Starlight's own icon set is filled and reads heavier than the landing
 * page wants, so these live here rather than coming from `<Icon>`.
 *
 * Each value is the inner markup of a 24×24 Lucide SVG, drawn with
 * `stroke="currentColor"` by the component that renders it.
 */
export const icons = {
