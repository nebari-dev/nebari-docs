...
![Nebari overview sequence showing deploying from yaml to cloud resources to the instance spinup selection](/img/classic/welcome/nebari_overview_sequence.png)
...
<Tabs>
  <TabItem label="Data practitioner">
...
🔸 [Log-in to your team's Nebari instance, launch your JupyterLab server](/classic/tutorials/login-keycloak/), and use the IPython/Jupyter notebooks.

🔸 Learn to [create new environments (kernels) using conda-store](/classic/tutorials/creating-new-environments/) if you need specific libraries.
...
🔸 The get started section will also take you to some "how-to guides" like the [deployment instructions for specific cloud-providers](/classic/get-started/cloud-providers/) and [DNS provisioning](/classic/how-tos/domain-registry/).

🔸 After setup, [provide your team members access to your Nebari instance by configuring Keycloak][configure-keycloak].

🔸 If you face issues or challenges, check out the [Troubleshooting section](/classic/troubleshooting/) and [GitHub Discussions][github-discussions] to learn from the community. You can also look into [debugging your deployment](/classic/how-tos/debug-nebari/).

🔸 As a good security practice, [create and keep a manual backup](/classic/how-tos/manual-backup/) of your configurations and your team's work.

🔸 To get the latest features, bug fixes, and security patches, [upgrade your Nebari instance](/classic/how-tos/nebari-upgrade/) regularly.

🔸 If or when you need to, you can [destroy the instance and all associated resources](/classic/how-tos/nebari-destroy/).

  </TabItem>

  <TabItem label="Contributor">
...
> [Learn how to install and deploy Nebari from scratch →](/classic/get-started/installing-nebari/)

> Refer to [CLI commands in the Quick start →](/classic/get-started/quickstart/)
...
[↳ Read all guides](/classic/welcome/) */}
...
[get-started]: /classic/get-started/
[tutorials]: /classic/tutorials/
[how-tos]: /classic/how-tos/
[community]: /community/introduction/
[references]: /classic/references/
[release-notes]: /classic/references/RELEASE/
[using-dask]: /classic/tutorials/using_dask/
[using-vscode]: /classic/how-tos/using-vscode/
[configure-keycloak]: /classic/how-tos/configuring-keycloak/
[create-dashboards]: /classic/tutorials/create-dashboard/
