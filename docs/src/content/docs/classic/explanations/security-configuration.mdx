...
For more information on how to do this, see the [Change Keycloak root password section](/classic/how-tos/configuring-keycloak/#change-keycloak-root-password).
:::
