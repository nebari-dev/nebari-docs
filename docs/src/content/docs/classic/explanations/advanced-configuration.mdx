...
`project_name`: Determines the base name for all major infrastructure related resources on Nebari. Should be compatible with the Cloud provider's naming conventions. See [Project Naming Conventions](/classic/explanations/config-best-practices/#naming-conventions) for more details.
...
- [Security configuration](/classic/explanations/security-configuration/)
- [Cloud provider configuration](/classic/explanations/provider-configuration/)
- [JupyterLab and Dask profile configuration](/classic/explanations/profile-configuration/)
- [Customize JuputerHub theme](/classic/explanations/custom-overrides-configuration/)
- [Environment configuration](/classic/explanations/environments-configuration/)
- [Custom settings and overrides](/classic/explanations/custom-overrides-configuration/)
