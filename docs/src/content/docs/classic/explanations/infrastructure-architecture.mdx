...
![Nebari core concepts](/img/classic/explanations/core-concepts.png)
...
![Terraform](/img/classic/explanations/terraform.png)
...
![Kubernetes overall structure levels](/img/classic/explanations/kubernetes-concepts-architecture.jpg)
...
<Tabs>
  <TabItem label="Google GCP">

![GCP Architecture Diagram](/img/classic/explanations/architecture-diagram-gcp.png)

</TabItem>

<TabItem label="Amazon AWS">

![AWS Architecture Diagram](/img/classic/explanations/architecture-diagram-aws.png)

</TabItem>
<TabItem label="Azure">

![Azure Architecture Diagram](/img/classic/explanations/architecture-diagram-azure.png)
