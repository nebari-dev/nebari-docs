...
:::note
Also see the [Set up Argo Workflows documentation](/classic/how-tos/setup-argo/).
:::
...
submitting Argo workflows in Python. Learn more in the [Argo Workflows walkthrough tutorial](/classic/tutorials/argo-workflows-walkthrough/).
...
Now that you have had an introduction, check out the [more detailed tutorial](/classic/tutorials/argo-workflows-walkthrough/) on
