...
Nebari itself is generally accessed via [kubectl](/classic/how-tos/debug-nebari/#installing-kubectl)
...
![Form to create a new JupyterHub token](/img/classic/how-tos/jupyterhub-token.png)
