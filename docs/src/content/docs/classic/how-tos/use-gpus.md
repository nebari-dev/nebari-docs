...
## 1. Starting a GPU server
  ...
  3. Run the command `nvidia-smi`. The top right corner of the command's output should have the highest supported driver.
      ![nvidia-smi-output](/img/classic/how-tos/nvidia-smi-output.png)
...
## 3. Validating the setup
  ...
  ![jupyter-notebook-command-output](/img/classic/how-tos/pytorch-cuda-check.png)

<!-- Internal links -->
[profile-configuration]: /classic/explanations/profile-configuration/
[login-with-keycloak]: /classic/tutorials/login-keycloak/
