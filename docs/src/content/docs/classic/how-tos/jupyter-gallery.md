...
For more information about custom JupyterLab Overrides in the Nebari config, visit the [Custom Overrides Configurations](/classic/explanations/custom-overrides-configuration/#jupyterlab) documentation.
