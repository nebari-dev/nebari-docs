...
![Keycloak clients](/img/classic/how-tos/fine_grainer_permissions_keycloak_clients.png)
...
<div style="border-radius: 15px; border: 2px solid var(--sl-color-hairline); padding: 20px; margin-bottom: 20px">

<Tabs>
  <TabItem label="Analyst">
    <MarkdownTable
...
![Keycloak groups tab screenshot - user groups view](/img/classic/how-tos/keycloak_groups.png)

2. Give the new group an appropriate name.

![Keycloak add group form - name field set to conda-store-manager](/img/classic/how-tos/keycloak_new_group1.png)

3. Under **Role Mapping**, add the appropriate **Client Roles** as needed; there should be no need to update the **Realm Roles**.

![Keycloak group conda-store-manager form - role mappings tab focused with expanded client roles dropdown](/img/classic/how-tos/keycloak_new_group2.png)
...
![Keycloak group conda-store-manager form - role mappings tab focused](/img/classic/how-tos/keycloak_new_group3.png)
...
![Keycloak client add jupyterhub role](/img/classic/how-tos/keycloak_jupyterhub_client.png)

2. On the **Add Role** form, write a meaningful name and description for the role. Click **Save**.

![Keycloak clients add jupyterhub role form](/img/classic/how-tos/keycloak_jupyterhub_add_role.png)
...
![Keycloak clients add jupyterhub role attributes](/img/classic/how-tos/keycloak_add_role_attributes.png)
...
![Keycloak select user](/img/classic/how-tos/keycloak_select_user.png)

2. Select that user and click on the **Role Mappings** tab.

![Keycloak user role mapping tab](/img/classic/how-tos/keycloak_user_role_mapping_tab.png)

3. Select the client associated with the role.

![Keycloak user role mapping roles](/img/classic/how-tos/keycloak_user_role_mapping_roles.png)

4. Select the role in **Available Roles** and click **Add Selected >>**.

![Keycloak user role mapping add role](/img/classic/how-tos/keycloak_user_role_mapping_add_role.png)
