...
- Associate the user with one or more of the **Groups**. Out of the box, Nebari is deployed with the following groups: `admin`, `developer` and `analyst` (see [Creating and Managing Groups, Roles, and Directories](/classic/how-tos/fine-grained-permissions/) for more details).
