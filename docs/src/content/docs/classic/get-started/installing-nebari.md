...
![A representation of the output generated when Nebari help command argument is executed, the output contains a list of the available commands and their use.](/img/classic/get-started/nebari-help.png "Nebari's help command line output")
...
![A representation of the output generated when Nebari init help command is executed, the output contains a list of the available options and arguments and their use.](/img/classic/get-started/nebari-init-help-2.png "Nebari's init help command line output")
...
[advanced-configuration]: /classic/explanations/advanced-configuration/
[nebari-aws]: /classic/how-tos/nebari-aws/
[nebari-azure]: /classic/how-tos/nebari-azure/
[environment-management]: /classic/how-tos/nebari-environment-management/
[nebari-extension-system]: /classic/how-tos/nebari-extension-system/
...
[nebari-upgrade]: /classic/how-tos/nebari-upgrade/
