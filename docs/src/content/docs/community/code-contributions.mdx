...
This will also install the required dependencies for development.
...
:::note
If you use `zsh`, you may need to escape the square brackets:
...
- Update any relevant pages on narrative documentation on `nebari.dev`. Read [Contribute to Nebari's documentation](/community/doc-contributions/) for more details.
...
[community-tests]: /community/nebari-tests/
