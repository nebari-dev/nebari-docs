...
The deployment and integration tests help us test various features of a [local Nebari deployment on Kind](/classic/how-tos/nebari-local/),
...
[quickstart]: /classic/get-started/quickstart/
[debugging-nebari]: /classic/how-tos/debug-nebari/#debugging-the-kubernetes-cluster-using-k9s
