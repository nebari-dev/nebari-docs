...
If you have an [editable installation of Nebari](/community/code-contributions/#install-nebari-in-editable-mode), you can test your changes by running the [Nebari CLI commands][quickstart] from within your development environment.
...
The deployment and integration tests help us test various features of a [local Nebari deployment on Kind](https://classic.nebari.dev/how-tos/nebari-local/),
...
[quickstart]: https://classic.nebari.dev/get-started/quickstart/
[debugging-nebari]: https://classic.nebari.dev/how-tos/debug-nebari/#debugging-the-kubernetes-cluster-using-k9s
