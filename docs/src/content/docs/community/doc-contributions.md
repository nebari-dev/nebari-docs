...
- **Docstrings and READMEs** that are a part of the [nebari codebase][nebari-repo] and other GitHub repositories in the [nebari-dev][nebari-org], respectively. To contribute to these, check out [Contribute to Nebari's codebase](/community/doc-contributions/).
...
[Read the Nebari documentation style guide →](/community/style-guide/)
...
2. Follow the instructions in the [Pre-commit hooks section of Contribute to Nebari's codebase](/community/code-contributions/#pre-commit-hooks) to install the pre-commit hooks.
...
[code-contributions-develop]: /community/code-contributions/#develop-your-contribution
[code-contributions-submit]: /community/code-contributions/#submitting-your-contribution
[code-contributions-review]: /community/code-contributions/#review-process
