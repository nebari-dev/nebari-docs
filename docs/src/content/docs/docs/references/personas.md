---
title: Personas
description: An overview of NKP's three primary roles and what each one needs from the platform.
---

Nebari Kubernetes Platform (NKP) organizes its work around three primary roles. Understanding these roles clarifies who is responsible for each layer of the platform and what each group needs to be successful.
...
- Data scientists, machine learning (ML) engineers, researchers, and analysts who use the tools and environments the platform provides
- Proficient in Python or R, working daily with Jupyter notebooks, ML frameworks, and data pipelines
- Generally not responsible for infrastructure and expect the platform to work without extra effort on their part
...
- Scalable compute they can request on demand without involving infrastructure teams
