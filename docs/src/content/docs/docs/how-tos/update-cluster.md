...
:::note[Upgrading the Kubernetes version]
Bumping `kubernetes_version` has additional requirements. See [Upgrade Kubernetes version](/docs/how-tos/upgrade-kubernetes/)
:::
