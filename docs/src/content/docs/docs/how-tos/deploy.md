...
To upgrade the cluster's Kubernetes version, see [Upgrade Kubernetes version](/docs/how-tos/upgrade-kubernetes/) — version bumps have additional constraints beyond a normal config change.
