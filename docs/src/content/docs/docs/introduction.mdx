...
<CardGrid>
  <LinkCard title="Get Started with NKP" href="/docs/nkp/get-started/" description="Install the platform and run your first cluster." />
  <LinkCard title="Browse Software Packs" href="/docs/software-packs/" description="See the current catalog of Capabilities." />
  <LinkCard title="Build a Pack" href="/docs/software-packs/build-your-own/" description="Author your own Capability using the pack template." />
</CardGrid>
